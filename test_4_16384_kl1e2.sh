...
LOG_PATH="${VERL_AGENT_IO_LOG_PATH:-$PROJECT_DIR/logs/test_4_16384_kl1e2.log}"
...
# kl_coef=1e-2: strong KL penalty for aggressive exploration
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='test_4_16384_kl1e2' \
