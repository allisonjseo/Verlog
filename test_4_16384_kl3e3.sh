...
LOG_PATH="${VERL_AGENT_IO_LOG_PATH:-$PROJECT_DIR/logs/test_4_16384_kl3e3.log}"
...
# kl_coef=3e-3: higher KL penalty to encourage more exploration
python3 -m verl.trainer.main_ppo \
    ...
    algorithm.kl_ctrl.kl_coef=3e-3 \
    ...
    trainer.experiment_name='test_4_16384_kl3e3' \
