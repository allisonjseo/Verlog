...
LOG_PATH="${VERL_AGENT_IO_LOG_PATH:-$PROJECT_DIR/logs/test_4_16384_group.log}"
...
# reward_mode=group: all agents receive the total group utility (social welfare)
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='test_4_16384_group' \
    ...
    +envs.env_config.reward_mode=group \
